...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/prisma/generated/analytics",
    "prisma/generated/analytics",
  ]
...
path.join(process.cwd(), "prisma/prisma/generated/analytics/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/prisma/generated/analytics/schema.prisma")
